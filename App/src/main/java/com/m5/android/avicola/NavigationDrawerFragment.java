...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_navigation_drawer, container, false);
    ...
    private class DrawerOnClickListener implements View.OnClickListener {
        ...
        final private DrawerItem drawerItem;

        public DrawerOnClickListener(DrawerItem drawerItem) {
    ...
    public void setCanOpen(boolean val) {
        if (val) {
